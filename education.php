...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if(empty($input_URL)){
		...
		$sql = "SELECT * FROM education WHERE URL = '$input_URL'";
	...
	if(empty($URL_err) && empty($Name_err) && empty($UserName_err) && empty($SitePassword_err)){
		$sql = "INSERT INTO education (URL,Name, UserName, SitePassword)
...
<section class="home-section"> 
 <div class="home-content">
        ...
        <div class="container">
            <div class="text" style="font-size: xx-large;margin-left: 300px;">EDUCATION FORM</div>
                <div class="row">  
                    <div class="col-sm-8" style="margin-left: 100px; margin-top: 15px;" >
                        <form class="form" action="education.php" method="post"> 
                            <div>
