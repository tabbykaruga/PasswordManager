...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if(empty($input_URL)){
		...
		$sql = "SELECT * FROM mail WHERE URL = '$input_URL'";
	...
	// create payment form
	if(empty($URL_err) && empty($Name_err) && empty($Folder_err) && empty($UserName_err) && empty($SitePassword_err)){
		$sql = "INSERT INTO mail (URL,Name, UserName, SitePassword)
...
<section class="home-section"> 
 <div class="home-content">
        ...
        <div class="container">
            <div class="text" style="font-size: xx-large;margin-left: 300px;">MAIL FORM</div>
                <div class="row">  
